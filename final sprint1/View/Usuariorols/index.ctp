<div class="usuariorols index">
	<h2><?php echo __('Usuariorols'); ?></h2>
	...
	<?php foreach ($usuariorols as $usuariorol): ?>
	<tr>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $usuariorol['Usuariorol']['user_id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $usuariorol['Usuariorol']['user_id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $usuariorol['Usuariorol']['user_id']), null, __('Are you sure you want to delete # %s?', $usuariorol['Usuariorol']['user_id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
